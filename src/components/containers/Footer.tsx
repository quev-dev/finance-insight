...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <section
        id='qd-github-container'
        className='max-w-max mx-auto flex flex-row items-center justify-center gap-2 mb-6 p-2'
      >
        <p>GitHub:</p>
        <a
          rel='noreferrer'
          target='_blank'
          href='https://github.com/quev-dev/finance-insight'
        >
          finance-insight
        </a>
      </section>
